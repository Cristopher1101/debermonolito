<%@ Page Title="Editar Producto" Language="C#" MasterPageFile="~/Mantenimiento/Principal.master" AutoEventWireup="true" CodeBehind="nuevo_tbl_producto.aspx.cs" Inherits="Monolito4_B.Mantenimiento.nuevo_tbl_producto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .ua-field .hint { font-size: .75rem; color: #9e9e9e; margin-top: 4px; display:block; }
        
        .ua-media-block { margin-top: 22px; padding: 20px 18px 18px; border-radius: 16px; border: 1px solid #e8eaf6; background: linear-gradient(180deg, #fafbff 0%, #fff 100%); }
        .ua-media-block .ua-subh { margin: 0 0 16px; font-size: .95rem; font-weight: 700; color: #3949ab; }
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_contenido" runat="server">
    ...
    <div class="ua-wrap">
        <div class="ua-hero">
            ...
            <p>Ingresa la información básica y añade fotos a la galería (Mínimo 3).</p>
        </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <ContentTemplate>
                ...
                <asp:Label ID="lblMensaje" runat="server" CssClass="ua-msg" Visible="false" EnableViewState="false"></asp:Label>
                ...
                <div class="ua-card">
                    ...
                    <div class="ua-form-actions">
                        <asp:Button ID="btnGuardar" runat="server" CssClass="ua-btn ua-btn-primary" Text="Guardar Producto" OnClick="btnGuardar_Click" />
