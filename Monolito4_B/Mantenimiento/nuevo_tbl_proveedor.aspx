...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style>
        ...
        .ua-field input[type=text], .ua-field select {
            width: 100%;
            height: 46px;
            padding: 0 14px;
            border-radius: 12px;
            ...
            <contenttemplate>
                ...
                <div class="ua-card">
                    ...
                    <div class="ua-grid-form">
                        <div class="ua-field">
                            <label>Nombre:</label>
                            <asp:TextBox ID="txtNombre" runat="server" MaxLength="100" onkeypress="return /^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$/.test(event.key);"></asp:TextBox>
                        </div>
                        <div class="ua-field">
                            <label>Teléfono:</label>
                            <asp:TextBox ID="txtTelefono" runat="server" MaxLength="15" onkeypress="return event.charCode >= 48 && event.charCode <= 57;"></asp:TextBox>
                        </div>
