...
namespace Capa_Datos
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="db_aca0bc_monolito4am")]
    ...
    partial void Deletetbl_usuario_foto(tbl_usuario_foto instance);
		...
		public DataClasses1DataContext() : 
				base(global::Capa_Datos.Properties.Settings.Default.db_aca0bc_monolito4amConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class tbl_producto_imagen : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _pimg_path;
		
		private System.Nullable<bool> _pimg_es_principal;
    ...
    partial void Onpro_idChanging(int value);
    partial void Onpro_idChanged();
    partial void Onpimg_pathChanging(string value);
    partial void Onpimg_pathChanged();
    partial void Onpimg_es_principalChanging(System.Nullable<bool> value);
    partial void Onpimg_es_principalChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_pimg_path", DbType="VarChar(255) NOT NULL", CanBeNull=false)]
		public string pimg_path
		{
			get
			{
				return this._pimg_path;
			}
			set
			{
				if ((this._pimg_path != value))
				{
					this.Onpimg_pathChanging(value);
					this.SendPropertyChanging();
					this._pimg_path = value;
					this.SendPropertyChanged("pimg_path");
					this.Onpimg_pathChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_pimg_es_principal", DbType="Bit")]
		public System.Nullable<bool> pimg_es_principal
		{
			get
			{
				return this._pimg_es_principal;
			}
			set
			{
				if ((this._pimg_es_principal != value))
				{
					this.Onpimg_es_principalChanging(value);
					this.SendPropertyChanging();
					this._pimg_es_principal = value;
					this.SendPropertyChanged("pimg_es_principal");
					this.Onpimg_es_principalChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="tbl_producto_tbl_producto_imagen", Storage="_tbl_producto", ThisKey="pro_id", OtherKey="pro_id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
